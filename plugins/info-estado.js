...
let handler = async (m, { conn, isRowner }) => {
    ...
    let pp = 'https://qu.ax/pjKoG.jpg'; // Usamos la URL de la imagen aquí
    ...
    let Sisked = `╭─⬣「 *Estado De Bot Meliodas* 」⬣\n`;
    ...
    await conn.sendFile(m.chat, pp, 'nino.jpg', Sisked, m, null, rcanal);
}
